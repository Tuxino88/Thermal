...
#cTDP
echo 12000000 > /sys/class/powercap/intel-rapl/intel-rapl:0/constraint_0_power_limit_uw
echo 12000000 > /sys/class/powercap/intel-rapl/intel-rapl:0/constraint_1_power_limit_uw
echo 12000000 > /sys/class/powercap/intel-rapl-mmio:0/constraint_0_power_limit_uw
echo 12000000 > /sys/class/powercap/intel-rapl-mmio:0/constraint_1_power_limit_uw
echo 127926272 > /sys/class/powercap/intel-rapl/intel-rapl:0/constraint_0_time_window_us
echo 2440 > /sys/class/powercap/intel-rapl/intel-rapl:0/constraint_1_time_window_us
